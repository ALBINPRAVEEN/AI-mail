...
const GenerateMail = (props: Props) => {
  ...
  const prompt = `write an eye catchy and solid ai email to the recruiter for a any Developer position. for any skills and experience and base it on this context:${email}`;
  ...
  return (
    <div className="w-[90%] flex flex-col justify-center items-center mt-6 pb-16 text-center">
      ...
      <textarea
        ...
        placeholder={
          "e.g. write a cool email for me I'm a fresher looking for frontend roles. skills- react, typescript"
        }
      />
